...
struct OSDConnectionPriv : public crimson::net::Connection::user_private_t {
  ...
  ConnectionPipeline client_request_conn_pipeline{"client"};
  ConnectionPipeline peering_request_conn_pipeline{"peering"};
  ConnectionPipeline replicated_request_conn_pipeline{"replicated"};
};
